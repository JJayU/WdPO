...
img = np.zeros((300, 512, 3), dtype=np.uint8) #wysokosc, szerokosc, liczba kanalow
cv2.namedWindow('image')

# create trackbars for color change
cv2.createTrackbar('R', 'image', 0, 255, empty_callback) #nazwa, okno, wartosc domyslna, wartosc maksymalna, funkcja (ktora ma sie wywolac po zmianie wartosci)
